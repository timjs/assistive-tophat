...
\begin{proof}[Completeness of stride]
  ...
  \Case{\userule{S-ThenFail}}
   {
   Provided that $t_1\Then e_2,\sigma\Consistent_M \tilde{t},\tilde{\sigma},\Phi$ and \userule{S-ThenFail},
   then by the induction hypothesis, we have $\tilde{t}_1,\tilde{\sigma}\simstride\tilde{t}_1',\tilde{\sigma}',\phi$
   and $t_1',\sigma'\Consistent_M\tilde{t}_1',\tilde{\sigma}',\Phi\land\phi$.
  ...
  \Case{\userule{S-ThenCont}}
   {
   Provided that $t_1\Then e_2,\sigma\Consistent_M \tilde{t},\tilde{\sigma},\Phi$ and \userule{S-ThenCont},
   then by the induction hypothesis, we have $\tilde{t}_1,\tilde{\sigma}\simstride\tilde{t}_1',\tilde{\sigma}',\phi$
  ...
  \Case{\userule{S-OrRight}}
   {
   Provided that $t_1\Or t_2,\sigma\Consistent_M \tilde{t},\tilde{\sigma},\Phi$ and \userule{S-OrRight},
   then by the induction hypothesis, we have $\tilde{t}_1,\tilde{\sigma}\simstride\tilde{t}_1',\tilde{\sigma}',\phi$
   and $t_1',\sigma'\Consistent_M\tilde{t}_1',\tilde{\sigma}',\Phi\land\phi_1$.
