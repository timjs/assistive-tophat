...
\begin{proof}
  ...
  This means showing that $(\tilde{v},\tilde{i}:\tilde{is},\Phi)\in t,\sigma\drive{}^*$, with $\tilde{i}\sim i$ and $\Sat(\tilde{i}:\tilde{is}\land g\tilde{v})$. \fixme{(fix notation of sat)}
...
\fixme{proof of soundness of simulate}
...
\fixme{proof completeness of simulate}
