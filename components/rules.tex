...
\newmacro{RelationSI}
  {\tilde{t},\tilde{\sigma} \interact{} \overline{\tilde{t}',\tilde{\sigma}',\tilde{\imath},\phi}}


\newrule{SI-Handle}
  {\tilde{t},\tilde{\sigma} \handle{} \overline{\tilde{t}',\tilde{\sigma}',{\tilde{\imath},\phi_1}} \Quad
   \tilde{t}',\tilde{\sigma}' \tilde{\normalise} \overline{\tilde{t}'',\tilde{\sigma}'',\phi_2}}
  {\tilde{t},\tilde{\sigma} \interact{} \overline{\tilde{t}'',\tilde{\sigma}'',\tilde{\imath},\phi_1 \land \phi_2}}

%% Firsts %%

\newrule{R-Firsts}
  {t,\sigma\interact{}^*\overline{\tilde{v},\tilde{\imath}:\tilde{is},\Phi}}
