...
\begin{proof}[Soundness of simulate]
  ...
  By \cref{lem:soundinteracting}, we know that $t,\sigma\interact{i_1}t_1,\sigma_1$ exists, since $t,\sigma\Consistent_{\emptyset}t,\sigma,\True$.
  ...
  By repeatedly applying \cref{lem:soundinteracting}, until we arrive at $\tilde{t}_n,\sigma{t}_n$,
