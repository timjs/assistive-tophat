...
In \cref{sub:symbolic-tax,sub:symbolic-dining}, we study how these automatically generated hints influence the execution of the examples from \cref{sec:examples}.
...
%% It works like this
By defining the hints function in exactly the same way as we will present below, % in \cref{fig:hints},
it directly leverages the already existing symbolic execution for \STOPHAT.


\subsection{Symbolic execution}
\label{suc:symbolic-execution}
